...
import com.mayinews.g.utils.ShowPayDialog;
...
public class PayListAdapter1 extends BaseExpandableListAdapter {
    ...
    public interface GroupExpand1{
        void groupExpand(int position);//设置展开
    }

    private GroupExpand1 groupExpand;
     public void  setGroupExpand1(GroupExpand1 groupExpand){
    ...
    public PayListAdapter1(Context context) {
...
//        convertView.setBackgroundColor(colors[i]);
        ...
        groupViewHolder.openClose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                groupExpand.groupExpand(groupPosition);


            }
        });
       groupViewHolder.price.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
               ShowPayDialog.show(context);
           }
       });
        return convertView;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.exlistview_child_item,null);
