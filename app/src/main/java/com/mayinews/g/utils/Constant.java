...
public class Constant {
    ...
    public static final String LOGINURL="http://g.mayinews.com/api/login/";
    ...
    public static final String SEARCH ="http://g.mayinews.com/api/search/" ;
    public static final String SETNICKNAME = "http://g.mayinews.com/api/setnickname.html";
    public static final String GETUSERINFO = "http://g.mayinews.com/api/getuserinfo.html";

    public static final String SETUSERAVATAR = "http://g.mayinews.com/api/setuseravatar.html";
    public static final String POSTAVATAR = "http://g.mayinews.com/api/follow.html";
    public static final String FAVOR = "http://g.mayinews.com/api/favor.html"; //收藏专辑或者取消收藏
