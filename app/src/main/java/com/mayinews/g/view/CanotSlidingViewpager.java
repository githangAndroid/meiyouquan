...
public class CanotSlidingViewpager extends ViewPager {
    ...
    public interface LeftScr {

        public void leftScr();
    }


    public void setLeftScrLisener(LeftScr lis) {
        this.lis = lis;
    }
            ...
            if (isCanScroll) {
                ...
                switch (ev.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        float motionValue = ev.getRawX() - beforeX;
                        ...
                        beforeX = ev.getRawX();//手指移动时，再把当前的坐标作为下一次的‘上次坐标’，解决上述问题
                        break;
                    default:
                        break;
                }
